...
1. Create an account with CropGuide, with this users will be able to crop the image targeting the text only, I used the 7 day free trial.
...
1. Create an account with RapidApi for the Google Translate Api, it's also free but it's limited to 500 characters per month.
...
1. Set up and replace the Bootstrap src links as well. (Feel free to style it as you desire).
